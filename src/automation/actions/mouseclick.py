...
class MouseClickItem(SimpleCardWidget):

    class MouseClickAttributeItem(SimpleCardWidget):
        def __init__(self, parent_mouse_widget_item):
            ...
            #点击次数输入框
            self.click_times_edit = SpinBox()
            layout.addWidget(CaptionLabel("点击次数:"))
        ...
        def init_data(self):
            try:
                ...
                self.click_times_edit.setValue(self.parent_mouse_widget_item.nums.value())
        ...
        def confirm_click(self):
            try:
                ...
                # 获取点击次数
                nums = self.click_times_edit.value()
                # 获取父类的对应值
                ...
                self.parent_mouse_widget_item.nums.setValue(nums)
            except Exception as e:
                print(e)
...
#控件坐标拾取功能
    ...
    def get_attribute_widget_class(self):
        self.atribute_widget = self.MouseClickAttributeItem(self)
